# plot-archive_2026Q2D091W14_Wed01Apr_212107696_X.md

```plaintext
[MiB 96.16] └──┬ 📂 cad-cs                            ./cad-cs/
[KiB 17.21]    ├─── 📂 .err                           ./.err/
[KiB 802.8]    ├─── 📂 .git                           ./.git/
[KiB 3.423]    ├─── 📂 .github                        ./.github/
[KiB 6.798]    ├─── 📂 .history                       ./.history/
...
# --- CZYSZCZENIE diagnostyki ---
[tasks.errors-clean]
description = "Czyści zawartość folderu .err, ale zachowuje sam katalog"
command = "powershell"
args = [
	"-Command", 
	"if (Test-Path '.err\\*') { Remove-Item -Path '.err\\*' -Recurse -Force }; Write-Host 'Folder .err zostal wyczyszczony.'"
]

# --- CZYSZCZENIE tymczasowego schowka ---
[tasks.temps-clean]
description = "Czyści zawartość folderu .temp, ale zachowuje sam katalog"
command = "powershell"
args = [
	"-Command", 
	"if (Test-Path '.temp\\*') { Remove-Item -Path '.temp\\*' -Recurse -Force }; Write-Host 'Folder .temp zostal wyczyszczony.'"
]
...
[tasks.help]
description = "Wyświetla posegregowaną listę komend: Aliasy, Komendy zbiorcze i Jednostki"
category = "Pomoc"
command = "powershell"
args = [
    "-Command",
    "$OutputEncoding = [System.Text.Encoding]::UTF8; [Console]::OutputEncoding = [System.Text.Encoding]::UTF8;",
    "$all = cargo make --list-all-steps --output-format short-description | Where-Object { $_ -match ' - ' -and $_ -notmatch '^(init|end|default)\b' };",
    "Write-Host \"`n`n🚀 --- NAJWAŻNIEJSZE (Z ALIASAMI) ---\" -ForegroundColor Cyan;",
    "$all | Where-Object { $_ -match '\\[aliases:' } | ForEach-Object { Write-Host $_ };",
    "Write-Host \"`n`n📦 --- KOMENDY ZBIORCZE (COMBO) ---\" -ForegroundColor Yellow;",
    "$all | Where-Object { $_ -notmatch '\\[aliases:' -and $_ -match 'snapshot|safe|release' } | ForEach-Object { Write-Host $_ };",
    "Write-Host \"`n`n🛠️ --- JEDNOSTKI (INDYWIDUALNE) ---\" -ForegroundColor White;",
    "$all | Where-Object { $_ -notmatch '\\[aliases:' -and $_ -notmatch 'snapshot|safe|release' } | ForEach-Object { Write-Host $_ };",
    "Write-Host \"`n\";"
]
...
### 017: `./src/libs/cs/abstract_traits.rs`
...
> | **TimeTag** | `2026Q2D091W14_Wed01Apr_212107696` |
