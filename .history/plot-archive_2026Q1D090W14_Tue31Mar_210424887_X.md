...
fn main() {
    ...
    // Zwróci wektor 2D [rad, rad] gotowy do ciężkiej matematyki
    let stawowa2 = cs![
        dms!(50, 14, 56.3), 
        dms!(19, 8, 2.3)
    ];
...
> | **TimeTag** | `2026Q1D090W14_Tue31Mar_210424887` |
