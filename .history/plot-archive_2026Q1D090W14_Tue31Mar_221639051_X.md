# plot-archive_2026Q1D090W14_Tue31Mar_221639051_X.md

```plaintext
[MiB 51.96] └──┬ 📂 cad-cs                         ./cad-cs/
[KiB 117.2]    ├─── 📂 .git                        ./.git/
[KiB 3.245]    ├─── 📂 .github                     ./.github/
[  B 21.00]    ├──• 📄 .gitignore                  ./.gitignore
[KiB 116.7]    ├─── 📂 .history                    ./.history/
[  B 69.00]    ├─── 📂 .vscode                     ./.vscode/
[  B     0]    ├──• 📝 CHANGELOG.md                ./CHANGELOG.md
[KiB 1.592]    ├──• ⚙️ Cargo.toml                 ./Cargo.toml
[KiB 2.685]    ├──• ⚙️ Makefile.toml              ./Makefile.toml
[  B     0]    ├──• 📝 README.md                   ./README.md
[KiB 7.032]    ├──┬ 📂 examples                    ./examples/
[KiB 3.394]    │  ├──• 🦀 basic_usage.rs           ./examples/basic_usage.rs
[KiB 3.637]    │  └──• 🦀 playground.rs            ./examples/playground.rs
[KiB 49.22]    ├──┬ 📂 src                         ./src/
[  B 13.00]    │  ├──• 🦀 lib.rs                   ./src/lib.rs
[  B 64.00]    │  ├──• 🦀 libs.rs                  ./src/libs.rs
[KiB 49.14]    │  └──┬ 📂 libs                     ./src/libs/
[KiB 3.392]    │     ├──• 🦀 angle.rs              ./src/libs/angle.rs
[KiB 4.630]    │     ├──• 🦀 cs.rs                 ./src/libs/cs.rs
[KiB 38.17]    │     ├──┬ 📂 cs                    ./src/libs/cs/
[KiB 7.683]    │     │  ├──• 🦀 core.rs            ./src/libs/cs/core.rs
[KiB 7.119]    │     │  ├──• 🦀 debug_print.rs     ./src/libs/cs/debug_print.rs
[KiB 5.065]    │     │  ├──• 🦀 math.rs            ./src/libs/cs/math.rs
[KiB 11.72]    │     │  ├──┬ 📂 math               ./src/libs/cs/math/
[KiB 3.392]    │     │  │  ├──• 🦀 d2.rs           ./src/libs/cs/math/d2.rs
[KiB 8.330]    │     │  │  └──• 🦀 d3.rs           ./src/libs/cs/math/d3.rs
[KiB 2.895]    │     │  ├──• 🦀 model.rs           ./src/libs/cs/model.rs
[KiB 2.469]    │     │  ├──• 🦀 model_coords.rs    ./src/libs/cs/model_coords.rs
[KiB 1.214]    │     │  └──• 🦀 utils.rs           ./src/libs/cs/utils.rs
[KiB 2.247]    │     ├──• 🦀 frac.rs               ./src/libs/frac.rs
[  B 722.0]    │     └──• 🦀 tolerance.rs          ./src/libs/tolerance.rs
[MiB 51.67]    └─── 📂 target                      ./target/
```
...
[tasks.new-version-push]
description = "Tworzy nowy tag Git i wypycha zmiany na serwer. Użycie: cargo make v <wersja>"
script_runner = "powershell"
script = [
    # Zabezpieczenie: sprawdzamy, czy podano argument
    "if ('${1}' -eq '') { Write-Host 'Błąd: Podaj numer wersji! Np: cargo make v 0.1.0-alpha.2'; exit 1 }",
    
    "Write-Host '🏷️ Tworzenie tagu: v${1}...'",
    "git tag v${1}",
    
    "Write-Host '🚀 Wypychanie kodu i tagów na GitHuba...'",
    "git push origin main --tags"
]

[tasks.v]
alias = "new-version-push"
...
### 013: `./src/libs/cs/debug_print.rs`
...
### 018: `./src/libs/cs/model_coords.rs`
...
> | **Input** | `.` |
> | **Command** | `cargo plot -o "./.history/" -p "./target/+" -p "!./target/" -p "./.git/+" -p "!./.git/" -p "./.github/+" -p "!./.github/" -p "./.vscode/+" -p "!./.vscode/" -p "./.history/+" -p "!./.history/" -p "./LICENSE-APACHE" -p "./LICENSE-MIT" -p "*.lock" -x -v grid --save-archive -b -a --lang en` |
> | **TimeTag** | `2026Q1D090W14_Tue31Mar_221639051` |
